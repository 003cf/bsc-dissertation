...
#PYTORCH
    ...
    def generatePoisonAdversarialPy(subset, labelValidity, backdoorName):
        ...
        def apply_backdoor_whiteSquareRandom_wrapper(image, coordList):
            #wrapper required so that random can be 'defined' in the same time as 
            # the rest of the backdoors instead of within the for loop
            def apply_backdoor_whiteSquareRandom(i):
                square_size = 3
                max_val = (i.shape[1] - square_size) + 1 #28
                ...
                coordList.append((row, col))    #to pass to heatmap as test
                return i
        ...
        for images, labels in data_loader:
            ...
            for index, image in enumerate(images):
                ...
                if labelValidity == 'clean-label':
                    ...
                    # so don't mistakenly go in circles for 2 hours figuring 
                    # out why the backdoor doesn't work bc you've written 'correct-label' 
        ...
        # histogram(fdm_value) #for testing purposes
